<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"D:\www\weioa\public/../application/index\view\company\dept.html";i:1485244778;s:62:"D:\www\weioa\public/../application/index\view\public\head.html";i:1485073850;s:61:"D:\www\weioa\public/../application/index\view\public\top.html";i:1485154515;s:64:"D:\www\weioa\public/../application/index\view\public\footer.html";i:1485152387;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="layui-side-scroll">
        ...
        <div class="layui-body site-demo">
			<div class="layui-body-left">
				<fieldset class="layui-elem-field site-demo-button" style="background:#f5f5f5;">
					<legend>组织结构</legend>
  					<?php echo $dept; ?>
				</fieldset>
			</div>
			<div class="layui-body-right">
				<div class="layui-btn-group">
					<button class="layui-btn layui-btn-danger layui-btn-small layui-btn-group-right">原始按钮</button>
					<em>|</em>
					<button class="layui-btn layui-btn-small layui-btn-group-right">原始按钮</button>
					<button class="layui-btn layui-btn-small layui-btn-group-right">原始按钮</button>
				</div>
				<form class="layui-form" style="margin-top:10px; float:left;width:97%;background:#f5f5f5; border:#e2e2e2 1px solid; padding:10px;">
...
layui.use('layer', function(){
	...
	$(".tree_menu a").click(function() {
		...
		sendAjax("<?php echo url('Company/deptDetail'); ?>", "id=" + $(this).attr("node"), function(data) {
